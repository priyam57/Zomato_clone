  ...
  return (
    <div className='explore-card cur-po'>
        ...
        <div className='res-row'>
            ...
            {rating && <div className='res-rating absolute-center'>{rating} <i className='fi fi-rr-star absolute-center'></i>
            </div>}
        ...
        <div className='res-row'>
            {cuisines.length && ( <div className='res-cuisine'>
                 {cuisines.map((item,i)=>{
                    return <span className='res-tag'>{item} {i !== cuisines.length-1 && ","}</span>
                 })}
